...
public class Attribute_Timeout extends BaseClass{
	...
	@Test(description = "this method will enter username to the username textbox", invocationCount = 10)
	...
	@Test( dependsOnMethods = "enterUserName", timeOut = 3000)
